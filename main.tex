...
% core loss changing under pressure 
...
\begin{figure}[t]
  \centering 
  \includegraphics[width=3in, height=2in]{example-image-a}
...
\begin{figure}[t]
  ...
  \begin{subfigure}{\columnwidth}
    \centering
    \includegraphics[width=3in, height=2in]{example-image-b}
    \caption{}
  \end{subfigure}
