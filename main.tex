...
\begin{figure}
  ...
  \caption{FEA simulation of ferrite toroid under \SI{100}{\kilo\newton} load}
  \label{fig:holderfea}
\end{figure}
\begin{table}
  \centering
  ...
  \begin{tabular}{@{}llll@{}}
    ...
    Material & TDK N95 & $L_p$ & \textcolor{red}{\SI{5}{\micro\henry}} \\
    Inner Diameter & \SI{64}{\milli\meter} & $L_s$ & \textcolor{red}{\SI{5}{\micro\henry}} \\
    Outer Diameter & \SI{80}{\milli\meter} & $k$ & \textcolor{red}{$0.99$} \\
    $N_p$ & 4 & $R_w$ & \textcolor{red}{\SI{119}{\milli\ohm}} \\
    $N_s$ & 4 & $C_s$ & \textcolor{red}{\SI{119}{\nano\farad}} \\
    \bottomrule
  \end{tabular}
\end{table}
